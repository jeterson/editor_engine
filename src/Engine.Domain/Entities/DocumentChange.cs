...
public sealed record EffectChangedChange(DocumentNodeId NodeId, EffectId EffectId) : DocumentChange(NodeId);
public sealed record EffectParameterChangedChange(DocumentNodeId NodeId, EffectId EffectId) : DocumentChange(NodeId);
